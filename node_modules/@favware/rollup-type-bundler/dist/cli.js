...
const command = new Command()
    ...
    .option('--no-build [noBuild]', 'When enabled (default: false) the build step will not be called. Useful if you want to only bundle types and handle building yourself.')
    .option('--no-clean [noClean]', 'When enabled (default: false) the clean step will not be called. Useful if you want to only bundle types and handle cleaning yourself.')
    .option('--only-bundle [onlyBundle]', 'A shortcut to enabling both `--no-build` and `--no-clean`. This essentially makes it so rollup-type-bundler only deals with bundling types and nothing else.')
    .option('-t, --typings-file-extension [typingsFileExtension]', 'The input file extension for your typings files. Useful if you want to set `.cts` or `.mts`. If you forego adding a prefixing dot (`.`), it will be added for you.')
    .option('--output-typings-file-extension [outputTypingsFileExtension]', 'The output file extension for your typings files. Useful if you want to set `.cts` or `.mts`. If you forego adding a prefixing dot (`.`), it will be added for you. Defaults to the value of "typingsFileExtension"')
    ...
    .option('--exclude-from-clean [excludeFromClean...]', [
